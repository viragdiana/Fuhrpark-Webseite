...
<main class="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <a href="../../index.php" class="w-full sm:w-auto flex items-center justify-center gap-2 bg-primary text-primary-foreground hover:opacity-90 px-4 py-2.5 text-sm font-medium rounded-md shadow-sm transition-opacity" title="Gehen Sie zum Fahrzeugprofil, um eine Wartung zu protokollieren">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div class="bg-card rounded-xl p-6 shadow-sm border border-border flex items-center gap-5">
            ...
            <div>
                <div class="text-sm text-muted-foreground font-medium">Gesamt Interventionen</div>
                <div class="text-3xl font-bold text-foreground"><?= $totalInterventions ?></div>
            </div>
        </div>
        ...
        <div class="bg-card rounded-xl p-6 shadow-sm border border-border flex items-center gap-5">
            ...
            <div>
                <div class="text-sm text-muted-foreground font-medium">Gesamtkosten</div>
                <div class="text-3xl font-bold text-foreground"><?= number_format($totalCost, 0, ',', '.') ?> €</div>
            </div>
        </div>
        ...
        <div class="bg-card rounded-xl p-6 shadow-sm border border-border flex items-center gap-5">
            ...
            <div>
                <div class="text-sm text-muted-foreground font-medium">Durchschnittskosten</div>
                <div class="text-3xl font-bold text-foreground"><?= number_format($avgCost, 0, ',', '.') ?> €</div>
            </div>
        </div>
                ...
                <?php if (empty($vehicleCosts)): ?>
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center text-muted-foreground">
                            <i class="bi bi-car-front text-4xl mb-3 block text-border"></i>
                            Keine Fahrzeuge im System gefunden.
                        </td>
                    </tr>
                <?php endif; ?>
                </tbody>
